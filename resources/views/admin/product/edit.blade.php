                           ...
                           <div class="row">
                              <div class="col-md-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class=" col-sm-10">
                                       <select id= "color" class="form-control" multiple title="Bảo Hành" id="color" name="color[]" required>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class=" col-sm-10">
                                       <select  id= "size" class="form-control" multiple title="Thương hiệu" name="size[]" required>
