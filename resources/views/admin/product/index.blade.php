                     ...
                     <div class="tab-pane fade active in" id="product_general">
                        <div class="row">
                           <div class="col-md-12">
                              ...
                              <div class="form-group">
                                 <label class="  col-sm-2  ">Bảo Hành<span class="asterisk">*</span></label>
                                 <div class=" col-sm-10">
                                    <select class="form-control" multiple title="Bảo Hành" id="color" name="color[]" required>
                              ...
                              <div class="form-group">
                                 <label class="  col-sm-2  ">Thương Hiệu<span class="asterisk">*</span></label>
                                 <div class=" col-sm-10">
                                    <select class="form-control" multiple title="Thương hiệu" name="size[]" required>
