...
@section('title')
<title>DangQuangTech - Đăng nhập hệ thống</title>
@endsection
@section('content')
            ...
            <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
                <div class="login-box clearfix animated flipInY">
                    ...
                    <div class="login-logo">
                        <a href="#">
                            <span style="color: #0090D9;font-size:30px;margin-right:2px">Dang</span><span style="color: white;font-size:20px"> QuangTech</span>
                        </a>
                    </div>
                    <hr>
