...
@section('head')
<title>DangQuangTech-Hóa đơn</title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        ...
                                        <img src="public/source/page/img/logo/dang_quang_tech.png" class="img-responsive0" alt="themeforest" style="margin-bottom: 10px;">
                                        <address>
                                            <div >Địa chỉ: A1, Đường Nguyễn Cơ Thạch, Nam Tư Liêm, HN </div><br>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th  class="t-ct">Bảo Hành</th>
                                                <th  class="t-ct">Thương Hiệu</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="item-row">
                                                ...
                                                <td  class="t-ct"><div >Bảo Hành: {{$dt->color}}</div></td>
                                                <td  class="t-ct"><div >Thương Hiệu: {{$dt->size}}</div></td>                    
                                                <td class="t-ct ">
                                    ...
                                    <div class="well" style="text-align: center;margin-top:100px;padding:10px;margin-bottom:10px;">
                                        Cảm ơn quý khách đã mua hàng tại <strong>DangQuangTech</strong>.Mọi phản hồi xin gửi qua <strong>dangquangtechvn@gmail.com</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
