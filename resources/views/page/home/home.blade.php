@extends('page.layout')
@section('headmeta')
<title>DangQuangTech | Trang chủ</title>
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6">
            <div class="card mb-30"><a class="card-img-tiles" href="{{ route('typeproduct',['alias'=>'new']) }}">
                <div class="inner">
                  <div class="main-img"><img src="public/source/page/img/shop/categories/abcd.png" alt="Category"></div>
                  <div class="thumblist"><img src="public/source/page/img/shop/categories/1.jpg" alt="Category"><img src="public/source/page/img/shop/categories/8.jpg" alt="Category"></div>
                </div></a>
          ...
          <div class="col-md-4 col-sm-6">
            <div class="card mb-30"><a class="card-img-tiles" href="{{ route('typeproduct',['alias'=>'sale']) }}">
                <div class="inner">
                  <div class="main-img"><img src="public/source/page/img/shop/categories/2.jpg" alt="Category"></div>
                  <div class="thumblist"><img src="public/source/page/img/shop/categories/3.jpg" alt="Category"><img src="public/source/page/img/shop/categories/4.jpg" alt="Category"></div>
                </div></a>
              <div class="card-block text-center">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="card mb-30"><a class="card-img-tiles" href="{{ route('typeproduct',['alias'=>'top']) }}">
                <div class="inner">
                  <div class="main-img"><img src="public/source/page/img/shop/categories/5.jpg" alt="Category"></div>
                  <div class="thumblist"><img src="public/source/page/img/shop/categories/6.jpg" alt="Category"><img src="public/source/page/img/shop/categories/7.jpg" alt="Category"></div>
                </div></a>
              <div class="card-block text-center">
