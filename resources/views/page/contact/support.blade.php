@extends('page.layout')
@section('headmeta')
<title>DangQuangTech | Hỗ trợ </title>
            ...
            <div class="accordion" id="accordion" role="tablist">
              ...
              <div class="card">
                ...
                <div class="collapse" id="collapseThree" role="tabpanel">
                  <div class="card-block">Đối với thanh toán trước, DangQuangTech sẽ hoàn tiền cho bạn trong những trường hợp sau:
Bạn hủy đơn hàng khi DangQuangTech chưa đến bước vận chuyển và muốn nhận lại tiền đã thanh toán qua thẻ.
Bạn muốn trả lại hàng do lỗi sản xuất và không muốn đổi sang sản phẩm khác.
DangQuangTech sẽ hoàn tiền lại vào tài khoản cá nhân của bạn. Chúng tôi sẽ cố gắng hoàn tiền nhanh nhất có thể và thời gian hoàn tiền không quá 15 ngày tính từ khi xác nhận hoàn tiền.</div>
                </div>
              </div>
