@extends('page.layout')
@section('headmeta')
<title>DangQuangTech | Sản phẩm</title>
            ...
            <div class="isotope-grid cols-3 mb-2">
              ...
              <div class="grid-item">
                <div class="product-card" style="height: 370px;">
                  ...
                  <a class="product-thumb" href="{{ route('detailproduct',['alias'=>$product->alias,'id'=>$product->id]) }}"><img src="public/uploads/product/{{$product->image_product[0]['image']}}" alt="Product" style="height:170px"></a>
          ...
          <div class="col-xl-3 col-lg-4 pull-xl-9 pull-lg-8">
            <aside class="sidebar">
              ...
              <section class="widget widget-categories">
                ...
                <form class="price-range-slider" method="post"  action="{{ route('fill-price') }}" data-start-min="100000" data-start-max="500000" data-min="0" data-max="15000000000)" data-step="10000">
                    {{csrf_field()}}
